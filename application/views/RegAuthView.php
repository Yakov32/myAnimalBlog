...
<body>
	...
	<div class="login-page">
		<div class="form signIn-form">
			<form class="form-register" action="regist?cont_method=reg" method="POST">
				...
				<input type="submit" class ="form_submit reg_button" value ="SEND"></input>
			...
			<form class ="Login-form" action="login?method=autho" >
				...
				<input type="button" class ="form_submit log_button" value ="SEND"></input>
	...
	<!-- Script that verifies data in form-->
